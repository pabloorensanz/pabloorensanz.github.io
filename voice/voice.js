...
if (!('webkitSpeechRecognition' in window)) {
	...
	recognition.onresult = function(event) {
		...
		if(final_transcript) {
			...
			// if(transcript.match(/ir a nosotros/i)) window.location.href = "nosotros.html";
			// else if(transcript.match(/ir a servicios/i)) window.location.href = "servicios.html";
			// else if(transcript.match(/ir a trabajos/i)) window.location.href = "trabajos.html";
			// else if(transcript.match(/ir a contacto/i)) window.location.href = "contacto.html";
		} else {
	...
	recognition.onend = function() {
		recognizing = false;
		console.log('-- HAS TERMINADO DE HABLAR --');
		transcript_input = '';
